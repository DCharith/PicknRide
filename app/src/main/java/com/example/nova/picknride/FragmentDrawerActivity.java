...
import com.example.nova.adapters.NavDrawerListAdapter;
import com.example.nova.models.NavDrawerItem;

import java.util.ArrayList;

public class FragmentDrawerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fragment_drawer_layout);
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout,
                R.mipmap.action_bar_icon, //nav menu toggle icon
